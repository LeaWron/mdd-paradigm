...
from ..misc import (
    CameraRunningState,
)  # Importing the CameraRunningState enum for managing camera states
...
class Camera:
    ...
    def __init__(self):
        ...
        self.callback_and_param_lock = (
            threading.Lock()
        )  # A lock to manage access to callback settings
    ...
    def start_sampling(self):
        ...
        if self.camera_running_state == CameraRunningState.CLOSING:
            ...
            self.open()
        elif self.camera_running_state in {
            CameraRunningState.PREVIEWING,
            CameraRunningState.CALIBRATING,
        }:
            raise RuntimeError(
                "It is under previewing or calibration and cannot start sampling"
            )
        else:
    ...
    def stop_sampling(self):
        ...
        if self.camera_running_state == CameraRunningState.SAMPLING:
            ...
            raise RuntimeError(
                "It is under previewing or calibration and cannot stop sampling"
            )
        else:
    ...
    def start_previewing(self):
        ...
        if self.camera_running_state == CameraRunningState.CLOSING:
            ...
            CameraRunningState.SAMPLING,
            CameraRunningState.CALIBRATING,
        }:
            raise RuntimeError(
                "It is under sampling or calibrating and cannot start previewing"
            )
        else:
    ...
    def stop_previewing(self):
        ...
        if self.camera_running_state == CameraRunningState.PREVIEWING:
            ...
            raise RuntimeError(
                "It is under sampling or calibrating and cannot stop previewing"
            )
        else:
    ...
    def start_calibrating(self):
        ...
        if self.camera_running_state == CameraRunningState.CLOSING:
            ...
            raise RuntimeError(
                "It is under sampling or previewing and cannot start calibrating"
            )
        else:
    ...
    def stop_calibrating(self):
        ...
        if self.camera_running_state == CameraRunningState.CALIBRATING:
            ...
            raise RuntimeError(
                "It is under sampling or previewing and cannot stop calibrating"
            )
        else:
