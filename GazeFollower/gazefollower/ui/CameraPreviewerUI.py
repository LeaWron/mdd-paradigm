...
class CameraPreviewerUI(BaseUI):
    ...
    def __init__(self, win, backend_name: str = "PyGame", bg_color=(255, 255, 255)):
        ...
        self.frame_rect = (
            self._margin * 2,
            self._margin * 2 + self._tip_text_size[1],
            *self._face_image_size,
        )
        # face and eye patch rectangles
        self.face_rect = (
            self._margin * 4 + self._face_image_size[0],
            self._margin * 2 + self._tip_text_size[1],
            *self._face_image_size,
        )
        self.right_eye_rect = (
        ...
        self._frame_text_rect = (
            self._margin,
            self._margin,
            self._face_image_size[0] + self._margin,
            self._tip_text_size[1],
        )
        self._face_text_rect = (
            self._margin * 3 + self._face_image_size[0],
            self._margin,
            self._face_image_size[0] + 2 * self._margin,
            self._tip_text_size[1],
        )
        self._left_eye_text_rect = (
            self._margin,
            self._face_image_size[1] + self._margin * 3 + self._tip_text_size[1],
            self._face_image_size[0] + 2 * self._margin,
            self._tip_text_size[1],
        )
        self._right_eye_text_rect = (
            self._margin * 3 + self._face_image_size[0],
            self._face_image_size[1] + self._margin * 3 + self._tip_text_size[1],
            self._face_image_size[0] + 2 * self._margin,
            self._tip_text_size[1],
        ...
        self._rect_list = [
            ...
            (
                self._margin,
                self._margin + self._tip_text_size[1],
                self._face_image_size[0] + 2 * self._margin,
                self._face_image_size[1] + 2 * self._margin,
            ),  # 2
            (
                self._margin * 3 + self._face_image_size[0],
                self._margin + self._tip_text_size[1],
            ...
            (
                ...
                + self._face_image_size[1],
                self._eye_image_size[0] + 2 * self._margin,
                self._tip_text_size[1],
            ),  # 4
            (
                self._margin * 3 + self._face_image_size[0],
            ...
            (
                self._margin,
                self._margin * 3
                + self._tip_text_size[1] * 2
                + self._face_image_size[1],
                self._eye_image_size[0] + 2 * self._margin,
                self._eye_image_size[1] + self._margin * 2,
            ),  # 6
            (
                self._margin * 3 + self._face_image_size[0],
                self._margin * 3
                ...
                + self._face_image_size[1],
                self._eye_image_size[0] + 2 * self._margin,
                self._eye_image_size[1] + 2 * self._margin,
            ),  # 7
            (
                self._margin - 1,
                self._margin - 1,
                ...
                self._face_image_size[1]
                + self._eye_image_size[1]
                + 2 * self._tip_text_size[1]
                + 4 * self._margin,
            ),  # 8
            # 8
        ]
        ...
        self._table_left_top_position = (
            self._margin * 7 + face_rect_width * 2,
            self._margin * 2,
        )
        ...
        self._table_line_color = (
            150,
            150,
            150,
        )  # Darker gray for clearer line visibility

        self._layout_width = (
            self._face_image_size[0]
            + self._eye_image_size[0]
            + 9 * self._margin
            + self._table_column_width * 2
        )
        self._layout_height = (
            self._tip_text_size[1] * 2
            + self._face_image_size[1]
    ...
    def draw_rounded_button(self, rect):
        ...
        button_color = (
            self._button_hover_color if is_pos_in_rect else self._button_color
        )
    ...
    def draw_table(self, data, start_pos):
        ...
        for i, (key, value) in enumerate(data.items()):
            row_rect = (
                x,
                y + i * self._table_row_height,
                self._table_column_width * 2,
                self._table_row_height,
            )
            row_bg_color = (
                self._table_even_color if i % 2 == 0 else self._table_odd_color
            )
        ...
        _rect = (
            x - self._margin,
            y - self._margin,
            self._table_width + 2 * self._margin,
        ...
        self.stop_button_rect = (
            _button_boundary_x,
            _button_boundary_y,
            _button_boundary_width,
            _button_boundary_height,
        )
    ...
    def draw(self):
        ...
        self._table_left_top_position = (
            self._layout_start_x + _tmp_x,
            self._layout_start_y + _tmp_y,
        )

        self._rect_list = [
            self._shifting_layout(pygame.Rect(i)) for i in self._rect_list
        ]
        ...
        while self.running:
            ...
            self.backend.draw_text(
                ...
                self.image_font_size,
                text_color=self._color_black,
                rect=self._left_eye_text_rect,
            )
            self.backend.draw_text(
                self._right_eye_text,
                self.font_name,
                self.image_font_size,
                text_color=self._color_black,
                rect=self._right_eye_text_rect,
            )
