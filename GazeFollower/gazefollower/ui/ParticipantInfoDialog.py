...
class ParticipantInfoDialog:
    ...
    def create_widgets(self):
        # ID Label and Entry
        label_id = ttk.Label(
            self.root, text="Participant ID:", font=("Microsoft YaHei", 14)
        )
        label_id.grid(row=0, column=0, padx=20, pady=15, sticky="w")
        entry_id = ttk.Entry(
            self.root, textvariable=self.participant_id, font=("Microsoft YaHei", 14)
        )
        ...
        entry_age = ttk.Entry(
            self.root, textvariable=self.age, font=("Microsoft YaHei", 14)
        )
        entry_age.grid(row=1, column=1, columnspan=2, padx=20, pady=15, sticky="ew")

        # Gender Label and Combobox
        label_gender = ttk.Label(
            self.root, text="Gender:", font=("Microsoft YaHei", 14)
        )
        ...
        label_glasses = ttk.Label(
            self.root, text="Wears Glasses:", font=("Microsoft YaHei", 14)
        )
        label_glasses.grid(row=3, column=0, padx=20, pady=15, sticky="w")
        combo_glasses = ttk.Combobox(
            self.root,
            textvariable=self.glasses,
            state="readonly",
            font=("Microsoft YaHei", 14),
        )
