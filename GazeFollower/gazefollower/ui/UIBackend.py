...
class UIBackend:
    ...
    def draw_text_on_screen_center(
        self, text: str, font_name: str, font_size: int, text_color=(0, 0, 0)
    ):
        """Draw multi-line text centered on screen."""
        raise NotImplementedError

    def draw_text_in_bottom_right_corner(
        self, text: str, font_name: str, font_size: int, text_color=(0, 0, 0)
    ):
...
class PsychoPyUIBackend(UIBackend):
    def __init__(self, win):
        ...
        self.circle_stim = visual.ShapeStim(
            self.win,
            vertices="circle",
            size=(0, 0),
            fillColor=None,
        ...
        self.line_stim = visual.ShapeStim(
            self.win,
            vertices=[(0, 0), (0, 0)],
            fillColor=None,
            lineColor=None,
        ...
        self.rect_stim = visual.ShapeStim(
            self.win,
            vertices="rectangle",
            size=(0, 0),
            fillColor=None,
    ...
    def draw_text(
        ...
        self.text_stim.pos = self.pixel_to_psychopy_coordinate(
    ...
    def listen_event(self, host, skip_event=False):
        ...
        if hasattr(host, "stop_button_rect") and (
            (host.stop_button_rect is not None)
...
class PyGameUIBackend(UIBackend):
    ...
    def draw_text_in_bottom_right_corner(
        ...
        line_spacing = int(font_size * 0.2)
        total_text_height = (
            len(split_lines) * font_size + (len(split_lines) - 1) * line_spacing
        )
