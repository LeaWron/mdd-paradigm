...
def main() -> None:
    ...
    model_dir = model_dir.joinpath("calib_models")
    if not model_dir.exists():
        raise RuntimeError(f"Calibration model directory does not exist: {model_dir}. Please run the calibration script first.")
